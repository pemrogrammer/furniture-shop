  ...
  return (
    <>
      <section className=" h-screen navbar
                          ">
          <nav className="px-5 py-1 bg-transparent bg-gray-200
            ...
            <div className="min-w-max flex-1 hidden
              ...
              <div className="flex flex-row gap-10 justify-end place-items-center py-2 ">
                ...
                <a href="#companyProfile"className={`cursor-pointer item-menu `}>Company Profile</a>
                <a href="#contactUs" className={`cursor-pointer item-menu `}>Contact Us</a>
              </div>
            </div>
          </nav>
          <div 
            className={`flex flex-col items-center pt-40 h-screen bg-top 
                        md:bg-center ${styles.cover}`}
            style={style}>
